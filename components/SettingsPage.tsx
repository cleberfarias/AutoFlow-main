...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 bg-slate-50 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-900 dark:text-white mb-2">{t('settings.title')}</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-900 dark:text-white rounded-xl font-medium transition-colors"
            >
              <RotateCcw size={20} />
              {t('settings.reset')}
            </button>
        ...
        <div className="flex gap-6">
          {/* Sidebar */}
          <div className="w-64 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 h-fit sticky top-8">
          ...
          <div className="flex-1">
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-8">
              ...
              {activeTab === 'language' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-900 dark:text-white mb-2">{t('settings.language')}</h2>
                  <p className="text-slate-600 dark:text-slate-600 dark:text-slate-400 mb-6">{t('settings.language.desc')}</p>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      >
                        ...
                        <div className="text-slate-900 dark:text-white font-medium">{lang.label}</div>
                      </button>
                    ))}
                  </div>
                </div>
              ...
              {activeTab === 'appearance' && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.theme')}</h2>
                    <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.theme.desc')}</p>
                      ...
                      {[
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="text-slate-900 dark:text-white font-medium">{theme.label}</div>
                          </button>
                        );
                      })}
                    </div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.colorScheme')}</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.colorScheme.desc')}</p>
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.compactMode')}</span>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.animations')}</span>
                      <input
                        type="checkbox"
              ...
              {activeTab === 'notifications' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.notifications')}</h2>
                  <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.notifications.desc')}</p>
                  
                  <div className="space-y-4">
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.notifications.enabled')}</span>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.notifications.sound')}</span>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.notifications.desktop')}</span>
                      <input
                        type="checkbox"
              ...
              {activeTab === 'api' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.api')}</h2>
                  <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.api.desc')}</p>
                  
                  <div className="space-y-6">
                    {/* OpenAI */}
                    <div className="p-6 bg-slate-100 dark:bg-slate-700/30 rounded-lg">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">{t('settings.api.openai')}</h3>
                      ...
                      <div className="flex gap-3">
                        <div className="flex-1 relative">
                          <input
                            ...
                            placeholder="sk-..."
                            className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:border-violet-500"
                          />
                          <button
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-violet-500 hover:bg-violet-600 text-slate-900 dark:text-white rounded-lg font-medium transition-colors"
                        >
                          <Save size={20} />
                        </button>
                        {settingsManager.hasApiKey('openai') && (
                    ...
                    <div className="p-6 bg-slate-100 dark:bg-slate-700/30 rounded-lg">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-slate-900 dark:text-white">{t('settings.api.gemini')}</h3>
              ...
              {activeTab === 'editor' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.editor')}</h2>
                  <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.editor.desc')}</p>
                  
                  <div className="space-y-4">
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.editor.autoSave')}</span>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.editor.showGrid')}</span>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.editor.snapToGrid')}</span>
                      <input
                        type="checkbox"
              ...
              {activeTab === 'data' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.data')}</h2>
                  <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.data.desc')}</p>
                  
                  <div className="space-y-4">
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.data.autoBackup')}</span>
                      <input
                        type="checkbox"
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-700 rounded-lg transition-colors"
                    >
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.data.export')}</span>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-700 rounded-lg transition-colors"
                    >
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.data.import')}</span>
              ...
              {activeTab === 'advanced' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.advanced')}</h2>
                  <p className="text-slate-600 dark:text-slate-400 mb-6">{t('settings.advanced.desc')}</p>
                  
                  <div className="space-y-4">
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.advanced.debugMode')}</span>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                      <span className="text-slate-900 dark:text-white font-medium">{t('settings.advanced.betaFeatures')}</span>
                      <input
                        type="checkbox"
              ...
              {activeTab === 'about' && (
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{t('settings.about')}</h2>
                  <div className="mt-8 text-center">
                    ...
                    <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">AutoFlow AI</h3>
                    <p className="text-slate-400 mb-2">{t('settings.about.version')}: 1.0.0</p>
                    <p className="text-slate-600 dark:text-slate-400 mb-6">© 2026 AutoFlow. Todos os direitos reservados.</p>
